...
par.v  = 0.023367; free.v = 0; units.v = 'cm/d'; label.v = 'energy conductance';
par.L_m = 0.91592; free.L_m = 0; units.L_m = 'cm'; label.L_m = 'max structural length';
par.ome = 4.01641; free.ome = 0; units.ome = 'd.cm^2'; label.ome = 'contribution of ash free dry mass of reserve to total ash free dry biomass';
% other

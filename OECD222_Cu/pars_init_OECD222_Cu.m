...
%% parameters 
% stress
par.c_0 = 4.45; free.c_0 = 1; units.c_0 = 'mg/kg'; label.c_0 = ' No-Effect-Concentration';
...
par.ome = 4.01641; free.ome = 1; units.ome = 'd.cm^2'; label.ome = 'contribution of reserve to total dry biomass';
% other

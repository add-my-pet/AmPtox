...
% the first colum the know-abscissa and the second column the knot
% coordinates. The know coordinates are free parameters and are passed into
...
% customized filters such that f cannot be more or less than 1
...
EH0 = 0; % do this to speed up computations - since we only look at growth then we don't need to follow maturity explicitly and we save time by not needed to compute the initial maturity based on initial values of L, E and a -
